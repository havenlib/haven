...
use Evocatio\Bundle\WebBundle\Lib\PostReadHandler;
...
class PostFormHandler {
    ...
    public function __construct(PostReadHandler $read_handler, LanguageReadHandler $language_read_handler, SecurityContext $security_context, FormFactory $form_factory) {
