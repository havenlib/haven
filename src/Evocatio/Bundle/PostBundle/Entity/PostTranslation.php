...
/**
 * Evocatio\Bundle\PostBundle\Entity\PostTranslation
 *
 * @ORM\Table()
 * @ORM\Entity
 */
...
//        sets the title as the slug
     ...
     * Set parent
     *
     * @param Evocatio\Bundle\PostBundle\Entity\Post $parent
     */
    public function setParent(\Evocatio\Bundle\PostBundle\Entity\Post $parent) {
        $this->parent = $parent;
    }
     ...
     * Get parent
     *
     * @return Evocatio\Bundle\PostBundle\Entity\Post 
     */
