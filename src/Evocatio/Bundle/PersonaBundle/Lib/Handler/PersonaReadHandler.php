...
class PersonaReadHandler {
    ...
    public function get($id) {
        ...
        $entity = $this->em->getRepository("Evocatio\Bundle\PersonaBundle\Entity\Persona")->find($id);
    ...
    public function getAll() {
        return $this->em->getRepository("Evocatio\Bundle\PersonaBundle\Entity\Persona")->findAll();
    }
