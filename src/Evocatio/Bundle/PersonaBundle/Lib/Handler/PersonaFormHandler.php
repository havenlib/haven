...
namespace Evocatio\Bundle\PersonaBundle\Lib\Handler;
...
class PersonaFormHandler {
    ...
    public function createEditForm($id) {
        ...
        switch (get_class($entity)) {
            case "Evocatio\Bundle\PersonaBundle\Entity\Persona":
                $form_class = "Evocatio\Bundle\PersonaBundle\Form\ImagePersonaType";
                break;
            default:
                $form_class = "Evocatio\Bundle\PersonaBundle\Form\PersonaType";
                break;
        }
    ...
    public function createNewForm() {
        return $form = $this->doCreate('Evocatio\Bundle\PersonaBundle\Form\PersonaType');
    }
