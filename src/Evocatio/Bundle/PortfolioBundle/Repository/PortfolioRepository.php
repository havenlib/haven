...
namespace Evocatio\Bundle\PortfolioBundle\Repository;

use \Evocatio\Bundle\CoreBundle\Generic\StatusRepository;
use \Doctrine\ORM\QueryBuilder;
use Evocatio\Bundle\PortfolioBundle\Entity\Portfolio;

/**
 * Description of PortfolioRepository
 */
class PortfolioRepository extends StatusRepository {
    ...
    public function findAllPublished() {
        $this->filterByStatus(Portfolio::STATUS_PUBLISHED);
        return $this->getResult();
    }
