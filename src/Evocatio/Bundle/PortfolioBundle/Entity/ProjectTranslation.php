...
/**
 * Evocatio\Bundle\PortfolioBundle\Entity\ProjectTranslation
 *
 * @ORM\Table()
 * @ORM\Entity()
 */
class ProjectTranslation extends SluggableMappedBase {
     ...
     * Set parent
     *
     * @param \Evocatio\Bundle\PortfolioBundle\Entity\Project $parent
     * @return ProjectTranslation
     */
    public function setParent(\Evocatio\Bundle\PortfolioBundle\Entity\Project $parent = null) {
        $this->parent = $parent;
