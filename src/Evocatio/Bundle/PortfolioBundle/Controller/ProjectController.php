...
class ProjectController extends ContainerAware {
    ...
    public function indexAction() {
        $entities = $this->container->get("evocatio_portfolio.project.read_handler")->getAllPublished();
    ...
    public function listAction() {
        $entities = $this->container->get("evocatio_portfolio.project.read_handler")->getAll();
        foreach ($entities as $entity) {
            $delete_forms[$entity->getId()] = $this->container->get("evocatio_portfolio.project.form_handler")->createDeleteForm($entity->getId())->createView();
        }
    ...
    public function showAction($id) {
        $entity = $this->container->get("evocatio_portfolio.project.read_handler")->get($id);
        $delete_form = $this->container->get("evocatio_portfolio.project.form_handler")->createDeleteForm($id);
    ...
    public function createAction() {
        $edit_form = $this->container->get("evocatio_portfolio.project.form_handler")->createNewForm();
    ...
    public function addAction() {
        ...
        if ($edit_form->isValid()) {
            $this->container->get("evocatio_portfolio.project.persistence_handler")->save($edit_form->getData());
    ...
    public function editAction($id) {
        $entity = $this->container->get('evocatio_portfolio.project.read_handler')->get($id);
        $edit_form = $this->container->get("evocatio_portfolio.project.form_handler")->createEditForm($entity->getId());
        $delete_form = $this->container->get("evocatio_portfolio.project.form_handler")->createDeleteForm($entity->getId());
    ...
    public function deleteAction() {
        ...
        $this->container->get("evocatio_portfolio.project.persistence_handler")->delete($form_data['id']);
