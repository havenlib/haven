...
class TextContentTranslation extends TranslationMappedBase {
     ...
     * Set parent
     *
     * @param \Evocatio\Bundle\CmsBundle\Entity\TextContent $parent
     * @return TextContentTranslation
     */
    public function setParent(\Evocatio\Bundle\CmsBundle\Entity\TextContent $parent = null)
    {
        $this->parent = $parent;
     ...
     * Get parent
     *
     * @return \Evocatio\Bundle\CmsBundle\Entity\TextContent 
     */
