...
namespace Evocatio\Bundle\PosBundle\Repository;
...
/**
 * Evocatio\Bundle\PosBundle\Entity\ProductRepository
 *
...
class ProductRepository extends StatusRepository {
    ...
    public function findRandomPublished($limit = 1) {
        $max = $this->_em->createQuery('SELECT MAX(e.id) FROM EvocatioPosBundle:Product e WHERE e.status = :status')
