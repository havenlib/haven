...
/**
 * Evocatio\Bundle\PosBundle\Entity\GenericTranslation
 *
 * @ORM\Entity()
 */
class GenericProductTranslation extends TranslationMappedBase
{
     ...
     * Set parent
     *
     * @param Evocatio\Bundle\PosBundle\Entity\GenericProduct $parent
     * @return GenericProductTranslation
     */
    public function setParent(\Evocatio\Bundle\PosBundle\Entity\GenericProduct $parent = null)
    {
        $this->parent = $parent;
     ...
     * Get parent
     *
     * @return Evocatio\Bundle\PosBundle\Entity\GenericProduct 
     */
