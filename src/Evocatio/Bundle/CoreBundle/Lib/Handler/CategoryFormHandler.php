...
use Evocatio\Bundle\CoreBundle\Lib\Handler\CategoryReadHandler;
...
class CategoryFormHandler {
    ...
    public function __construct(CategoryReadHandler $read_handler, SecurityContext $security_context, FormFactory $form_factory) {
