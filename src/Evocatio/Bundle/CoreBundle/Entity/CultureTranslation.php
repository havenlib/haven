...
/**
 * Evocatio\Bundle\CoreBundle\Entity\CultureTranslation
 *
 * @ORM\Table()
 * @ORM\Entity()
 */
class CultureTranslation extends TranslationMappedBase {
     ...
     * Set parent
     *
     * @param Evocatio\Bundle\CoreBundle\Entity\Culture $parent
     */
    public function setParent(\Evocatio\Bundle\CoreBundle\Entity\Culture $parent)
    {
        $this->parent = $parent;
    }
     ...
     * Get parent
     *
     * @return Evocatio\Bundle\CoreBundle\Entity\Culture 
     */
