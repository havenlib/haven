...
/**
 * Evocatio\Bundle\CoreBundle\Entity\LanguageTranslation
 *
 * @ORM\Table()
 * @ORM\Entity()
 */
class LanguageTranslation extends TranslationMappedBase {
     ...
     * Set parent
     *
     * @param Evocatio\Bundle\CoreBundle\Entity\Language $parent
     */
    public function setParent(\Evocatio\Bundle\CoreBundle\Entity\Language $parent)
    {
        $this->parent = $parent;
    }
