...
class CultureController extends ContainerAware {
    ...
    public function editAction() {
        $current_language = $this->container->get("evocatio_core.language.read_handler")->getBySymbol($this->container->get('Request')->get('display_language'));
        $edit_form = $this->container->get("evocatio_core.culture.form_handler")->createEditForm($current_language->getSymbol());
    ...
    public function updateAction() {
        ...
        if ($edit_form->isValid()) {
            ...
            $this->container->get("evocatio_core.culture.persistence_handler")->save($edit_form->get("symboles")->getData(), $current_language->getSymbol());
